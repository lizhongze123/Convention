...
import com.gz0101.hzwy.camera.listener.ErrorListener;
import com.gz0101.hzwy.camera.listener.JCameraListener;
import com.gz0101.hzwy.camera.listener.TypeListener;
import com.gz0101.hzwy.camera.state.CameraMachine;
import com.gz0101.hzwy.camera.util.FileUtil;
import com.gz0101.hzwy.camera.util.LogUtil;
import com.gz0101.hzwy.camera.util.ScreenUtils;
import com.gz0101.hzwy.camera.view.CameraView;
...
//    private static final String TAG = "JCameraView";
    ...
    private View photo_folder_layout;
    ...
    private TextView mPreviewCancle;
    private TextView mPreviewFinish;
    private TextView mSendPhoto;
    ...
    private void initView() {
        ...
        photo_folder_layout = view.findViewById(R.id.photo_folder_layout);
...
//                mFlashLamp.setVisibility(INVISIBLE);
                photo_folder_layout.setVisibility(INVISIBLE);
                machine.capture();
            }
...
//                mFlashLamp.setVisibility(VISIBLE);
                photo_folder_layout.setVisibility(VISIBLE);
...
//                    rightClickListener.onClick();
        ...
        view.findViewById(R.id.photo_folder).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                jCameraLisenter.choosePicture();
//                openGallery(PictureConfig.TYPE_IMAGE);
            }
        });
        view.findViewById(R.id.photo_change).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                machine.swtich(mVideoView.getHolder(), screenProp);
            }
    ...
    private void showPhotoDialog() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.preview_picture_dialog_layout, null, false);
        final AlertDialog dialog = new AlertDialog.Builder(mContext, R.style.Dialog_Fullscreen).setView(view).create();
        dialog.show();

        mPreviewCancle = view.findViewById(R.id.preview_cancle);
        mPreviewFinish = view.findViewById(R.id.preview_finish);
        mPreviewPhoto = view.findViewById(R.id.preview_photo);
        mPreviewPhoto.setImageBitmap(captureBitmap);
        mPhoto.setScaleType(ImageView.ScaleType.FIT_XY);

        mPreviewCancle.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                machine.cancle(mVideoView.getHolder(), screenProp);
                dialog.dismiss();
        ...
        mPreviewFinish.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
//                jCameraLisenter.captureSuccess(captureBitmap);
                machine.cancle(mVideoView.getHolder(), screenProp);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (StatusBarUtil.hasCameraNotchInScreen(BaseApplication.getTopActivity())) {
            heightSize += StatusBarUtil.getStatusBarHeight(BaseApplication.getInstance());
        }
//        if (screenProp == 0) {
