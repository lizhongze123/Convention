...
//                activity.getWindow().getDecorView().setSystemUiVisibility( View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN|View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
    ...
    public static boolean setFlymeStatusBarLightMode(Window window, boolean dark) {
        ...
        if (window != null) {
            try {
                ...
                Log.i("status bar error :", "flyme status bar error" + e.getMessage());
            }
        }
        return result;
    }
    ...
    public static boolean setMiuiStatusBarLightMode(Window window, boolean dark) {
        ...
        if (window != null) {
            ...
            try {
                ...
                Log.i("status bar error :", "miui status bar error" + e.getMessage());
            }
        }
        return result;
    }
    ...
    public static boolean hasCameraNotchInScreen(BaseActivity activity) {
    ...
    private static boolean hasNotchHw(Activity activity) {
        try {
            ...
            Log.d("status bar", "error :" + e.getMessage());
            return false;
        }
    }
